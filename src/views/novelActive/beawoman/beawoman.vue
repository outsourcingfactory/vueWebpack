<template>
    <div id="app">
        <div v-show="!showWx">
            <div class="topimage">
                <img src="https://img.hongrenshuo.com.cn/h5/beawoman-topimage-ymz.png">
                <div class="rule" @click="goRule"></div>
                <div class="goBook" @click="_goNovel(2253289566225,2253294366782)"></div>
            </div>
            <div class="wrapertitle">
                <img src="https://img.hongrenshuo.com.cn/h5/beawoman-titleWrapper-ymz.png">
            </div>
            ...
            <div class="bottomImage" @click="_goBottom()">
                <img src="https://img.hongrenshuo.com.cn/h5/beawoman-bottomImage-ymz.png">
            </div>
...
<script>
    ...
    let shareTitle = '新倩女幽魂-公子景对话故事征集';
    let shareDesc = '写下与公子景的对话故事，朱一龙巨幅签名海报+丰厚奖金等你来拿！';
    let shareImageUrl = 'https://img.hongrenshuo.com.cn/h5/beawoman-wxshare-ymz.png';
    export default {
        data() {
            return {
                hotList: [],
...
//                }
            ...
            _getHotListNovel() {
                this.$axios.HttpGet('/HotPoint/hotList', {pageNo: this.page, type: 19})
                    .then((res) => {
                        console.log(res)
            ...
            _getNewListNovel() {
                this.$axios.HttpGet('/HotPoint/newestList', {pageNo: this.page, type: 19})
                    .then((res) => {
                        console.log(res)
                        if (res.data.code === 200) {
                            if (res.data.data.length < 20) {
