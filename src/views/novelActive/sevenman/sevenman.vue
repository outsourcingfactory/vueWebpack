...
<script>
    ...
    var shareTitle = '七侠五义同人对话小说大赛';
    var shareDesc = '《新七侠五义之屠龙案》爱奇艺火热上映中，现在参与活动，写文赢千元现金奖励';
    var shareImageUrl = 'https://img.hongrenshuo.com.cn/h5/sevenman-wxshare-ymz.jpg';
    export default {
        data() {
            return {
                hotList: [],
        ...
        methods: {
            ...
            goRule() {
                window.location.href = '/Rule/sevenmanrule?showshare=1';
            },
            ...
            _getHotListNovel() {
                this.$axios.HttpGet('/HotPoint/hotList', {pageNo: this.page, type: 21})
                    .then((res) => {
                        console.log(res)
            ...
            _getNewListNovel() {
                this.$axios.HttpGet('/HotPoint/newestList', {pageNo: this.page, type: 21})
                    .then((res) => {
                        console.log(res)
                        if (res.data.code === 200) {
                            if (res.data.data.length < 20) {
...
<style lang="scss" scoped>
    #app {
        width: 100%;
        background: url("https://img.hongrenshuo.com.cn/h5/sevenman-bgcon-ymz.png") repeat-y center;
