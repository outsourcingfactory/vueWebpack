    ...
    <div id="app">
        <div v-show="!showWx" class="appin">
            <div class="topimageOut">
                <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/counterattack3-image.png`"></Onepic>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            goUrl: function (type) {
                if (type == 1) {
                    window.location.href = '/Rule/counterattack-rule3';
                } else if (type == 2) {
            ...
            getRoomList: function () {
                ...
                this.huancun = true;
                this.tips = '';
                this.$axios.HttpGet('/Active/potentialStarList3', {
                    period: this.period
                })
                    .then((res) => {
...
//                let nowTime = 1535299211;
                ...
                let time2 = 1548864000; //01月31号0点
                let time3 = 1549036800; //02月02号0点
                let time4 = 1549123200; //02月03号0点
