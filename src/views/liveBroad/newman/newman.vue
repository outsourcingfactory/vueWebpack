<template>
    <div id="app">
        ...
        <div class="tab">
            <div class="tabLi" @click="checkTab(1)" :class="group==1?'tabLiActive':''">
                <div class="tabLeft">
                    <p>九天</p>
                    <p>新星组</p>
                </div>
            </div>
            <div class="tabLi" @click="checkTab(2)" :class="group==2?'tabLiActive':''">
                <div>
                    <p>九天</p>
                    <p>行星组</p>
                </div>
            </div>
            <div class="tabLi" @click="checkTab(3)" :class="group==3?'tabLiActive':''">
                <div class="tabRight">
                    <p>九天</p>
                    <p>恒星组</p>
                </div>
...
<script>
    ...
    let shareTitle = '九天星势力';
    let shareDesc = '快来支持你喜欢的主播大大吧～！';
    ...
    export default {
        ...
        methods: {
            ...
            getDataList:function () {
                ...
                this.huancun = true;
                this.dataList = [];
                this.$axios.HttpGet('/UnionActive/jiutianList',{group:this.group})
                    .then((res) => {
...
<style lang="scss">
    #app{
        width: 100%;
        height: 1684px;
        background: url("https://img.hongrenshuo.com.cn/h5/newman-conBody-ymz.png") no-repeat center;
        ...
        .tab{
            width: 357px;
            height: 86px;
            background: url("https://img.hongrenshuo.com.cn/h5/newman-tab-ymz.png") no-repeat center;
            background-size: 100% 100%;
            position: absolute;
            left: 9px;
            top: 640px;
