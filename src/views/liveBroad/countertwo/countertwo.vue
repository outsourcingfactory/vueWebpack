    ...
    <div id="app">
        <div v-show="!showWx" class="appin">
            <div class="topimageOut">
                <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/countertwo-topimage-ymz.png`"></Onepic>
        ...
        methods: {
            ...
            goBottom: function () {
                if (this.$refs.tips.innerText == '下载克拉克拉') {
                    let webrul = encodeURI('https://live.hongdoulive.com/Active/potentialStarIndex2?showshare=1')
            ...
            goUrl: function (type) {
                if (type == 1) {
                    window.location.href = '/Rule/countertwo-rule';
                } else if (type == 2) {
            ...
            getRoomList: function () {
                ...
                this.huancun = true;
                this.tips = '';
                this.$axios.HttpGet('/Active/potentialStarList2', {
                    period: this.period
                })
                    .then((res) => {
            ...
            getNowType: function () {
                ...
                let time2 = 1543161600; //11月26号0点
                let time3 = 1543334400; //11月28号0点
                let time4 = 1543420800; //11月29号0点
                if (nowTime < time2) { //海选
                    this.period = 1;
