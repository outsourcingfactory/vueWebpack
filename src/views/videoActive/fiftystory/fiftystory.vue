<template>
    <div id="app">
        <div v-show="!showWx">
            <div class="topimage">
                <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/fiftystory-topimage-ymz.png`"></Onepic>
            ...
            <div class="bottomBtn" @click="goCreateVideo()">
                <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/fiftystory-bottomBtn-ymz.png`"></Onepic>
            </div>
...
//                        等待封装toast
            ...
            goRule: function () {
                window.location.href = '/Rule/fiftystoryrule.html';
            },
