<template>
    <div id="app">
        <div v-show="!showWx">
            <div class="topimage">
                <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/sevenactive-topimage-ymz.png`"></Onepic>
            ...
            <div class="content">
                ...
                <div>
                    <ScrollUpLoading :tipDesc="tipDesc" :showload="showload" :color="'#1f054f'"></ScrollUpLoading>
                </div>
                <div class="tipsAl">
                    本活动最终解释权归KilaKila所有
                </div>
            ...
            <div class="bottomBtn" @click="goCreateVideo()">
                <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/sevenactive-bottomImage-ymz.png`"></Onepic>
            </div>
...
<script>
    ...
    let shareTitle = '七夕发糖';
    let shareDesc = '你最萌的二次元同人CP发糖啦，吃下这个安利～';
    let shareImageUrl = 'https://img.hongrenshuo.com.cn/h5/sevenactive-wxshare-ymz.png';
    export default {
        data() {
            return {
                leftActive: true,
                rightActive: false,
                exampleVideo: ['1168388665655689327', '1168368058402603158', '1168366439199932541', '1168366104192483461'],
                videoAll: {
                    exampleVideoList: [],
                    showVideoList: []
                },
...
//                            给示范视频打标记
                            if (this.leftActive) {
                                for (let i = 0; i < res.data.data.length; i++) {
                                    res.data.data[i].videoDetailResp.videoResp.coverPic = ymzBaseFun.addWen(res.data.data[i].videoDetailResp.videoResp.coverPic);
...
//                        等待封装toast
            ...
            goRule: function () {
                window.location.href = '/Rule/sevenactiverule?showshare=1';
            },
