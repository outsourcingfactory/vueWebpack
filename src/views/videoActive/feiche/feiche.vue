<template>
    <div id="app">
        <div v-show="!showWx" class="appcontent">
            <div>
                <div class="topimage">
                    <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/feiche-img_01.png`"></Onepic>
...
<script>
    ...
    let shareTitle = '飞车群英会';
    let shareDesc = '速度与激情，野蛮与狂热，炫酷飞车不仅是视觉盛宴更有豪礼相送！';
    let shareImageUrl = 'https://img.hongrenshuo.com.cn/h5/feiche-share.jpg';
     export default {
        data(){
            return{
                videoList:[],
                ...
                videostyle:{
                    ...
                    authorname:'#fff',
                    likeCount:'#000',
                    zanBtn:'https://img.hongrenshuo.com.cn/h5/feiche-toupiaobtn.png'
                },
                showConfirm: false,
        ...
        methods:{
            ...
            gorule(){
                window.location.href = '/Rule/feiche-rule.html'
            },
            changePage() {
    ...
    #app{
        ...
        .bottomOut {
            ...
            .bottom {
                ...
                width: 351px;
                height: 50px;
                background:#04829c url("https://img.hongrenshuo.com.cn/h5/feiche-bottom-btn.png") no-repeat center;
