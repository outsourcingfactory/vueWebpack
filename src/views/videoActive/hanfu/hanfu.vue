<template>
    <div id="app">
        <div class="itemcontent" v-show="!showWx">
            <div>
                <div class="topimage">
                    <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/hanfu-image_01.png`"></Onepic>
                ...
                <div class="bottomBtn" @click="goCreateVideo()">
                    <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/hanfu-bottom-btn.png`"></Onepic>
                </div>
...
<script>
    ...
    let shareTitle = '15秒种草汉服！';
    let shareDesc = '还在吃土吗少女？拍摄短视频，免费获得汉服的机会来啦！';
    let shareImageUrl = 'https://img.hongrenshuo.com.cn/h5/hanfu-shareicon.jpg';
    export default {
        data() {
            return {
                leftActive: true,
                rightActive: false,
                exampleVideo: ['1152477546990796883','1153132018402328605','1153146904758976561','1154395533356302458','1154232457743040639'],
...
//                        等待封装toast
            ...
            goRule: function () {
                window.location.href = '/Rule/hanfu-rule.html';
            },
...
<style lang="scss" scoped>
    #app {
        ...
        .content {
            border-top: 1px solid #715946;
            border-bottom: 1px solid #715946;
            background: #f2eeec;
            width: 100%;
            .title {
                width: 100%;
