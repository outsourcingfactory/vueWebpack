<template>
    <div id="app">
        <div class="itemcontent" v-show="!showWx">
            <div>
                <div class="topimage">
                    <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/wherebaby-image.png`"></Onepic>
                ...
                <div class="bottomBtn" @click="goCreateVideo()">
                    <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/wherebaby-bottombtn.png`"></Onepic>
                </div>
...
<script>
    ...
    let shareTitle = '哪里来的绝世大宝贝？！';
    let shareDesc = '克拉克拉同人短视频安利大赏';
    let shareImageUrl = 'https://img.hongrenshuo.com.cn/h5/wherebaby-share.png';
    export default {
        data() {
            return {
                leftActive: true,
                rightActive: false,
                exampleVideo: ['1173560540719480867','1181513110754689047','1177000148098613342'],
...
//                        等待封装toast
            ...
            goRule: function () {
                window.location.href = '/Rule/wherebaby-rule.html';
            },
