<template>
    <div id="app">
        <div class="itemcontent" v-show="!showWx">
            <div>
                <div class="topimage">
                    <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/halloween-image_01.png`"></Onepic>
                ...
                <div class="bottomBtn" @click="goCreateVideo()">
                    <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/halloween-bottom-btn.png`"></Onepic>
                </div>
...
<script>
    ...
    let shareTitle = '万圣游园会';
    let shareDesc = '变装短视频征集令已发布，等你来疯狂变装嗨翻天!';
    let shareImageUrl = 'https://img.hongrenshuo.com.cn/h5/halloween-share.png';
    export default {
        data() {
            return {
                leftActive: true,
                rightActive: false,
                exampleVideo: ['1195084704898875451','1195064759070752826','1195116616505884712'],
...
//                        等待封装toast
            ...
            goRule: function () {
                window.location.href = '/Rule/halloween-rule.html';
            },
