<template>
    <div id="app">
        <div class="itemcontent" v-show="!showWx">
            <div>
                <div class="topimage">
                    <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/sweetChristmas-image.png`"></Onepic>
                ...
                <div class="bottomBtn" @click="goCreateVideo()">
                    <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/sweetChristmas-bottombtn.png`"></Onepic>
                </div>
...
<script>
    ...
    let shareTitle = '甜蜜圣诞制造局—短视频征集';
    let shareDesc = '你萌的CP在圣诞会不会发糖';
    let shareImageUrl = 'https://img.hongrenshuo.com.cn/h5/sweetChristmas-share.png';
    export default {
        data() {
            return {
                leftActive: true,
...
//                        等待封装toast
            ...
            goRule: function () {
                window.location.href = '/Rule/sweetChristmasrule';
            },
...
<style lang="scss" scoped>
    #app {
        ...
        .content {
            border-top: 1px solid #d8432f;
            border-bottom: 1px solid #d8432f;
            background: #ea5c5c;
            width: 100%;
            .title {
                width: 100%;
