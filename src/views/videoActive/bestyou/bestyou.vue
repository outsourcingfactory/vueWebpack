<template>
    <div id="app">
        <div v-show="!showWx" class="appcontent">
            <div>
                <div class="topimage">
                    <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/bestyou-img_01.png`"></Onepic>
                    <div class="gotoRule" @click="gorule()"></div>
                </div>
                <div class="videoCover">
                    <div class="showVideo" @click="playClick()" v-show="showVideoImg">
                        <img src="https://img.hongrenshuo.com.cn/h5/starcp3-showVideo-ymz.png" alt="">
                    </div>
                    <div class="coverpic" v-show="showCoverPic">
                        <img :src="'https://img.hongrenshuo.com.cn/h5/bestyou-videocover.jpeg?x-oss-process=image/resize,m_mfit,h_196,w_330,limit_0/crop,w_330,h_196,g_center'" alt="">
                    </div>
                    <!--<video v-show="showVideo" controls="controls" playsinline="true" webkit-playsinline="true" preload="metadata" :src="" x-webkit-airplay="allow" x5nativepanel x5-video-player-type="h5" x5-video-player-fullscreen="true"></video>-->
                </div>
                <div class="topimage">
                    <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/bestyou-img_02.png`"></Onepic>
    ...
    let shareImageUrl = 'https://img.hongrenshuo.com.cn/h5/bestyou-share.png';
     export default {
        data(){
            return{
                ...
                videostyle:{
                    ...
                    titlename:'#5d5454',
                    authorname:'#5d5454',
                    zanBtn:'https://img.hongrenshuo.com.cn/h5/bestyou-zan.png'
                },
                showConfirm: false,
        ...
        methods:{
            ...
            gorule(){
                window.location.href = '/tg/bestyourule.html'
            },
            changePage() {
    ...
    #app{
        ...
        .bottomOut {
            ...
            .bottom {
                ...
                width: 351px;
                height: 50px;
                background: url("https://img.hongrenshuo.com.cn/h5/bestyou-bottomimg.png") no-repeat center;
                background-size: 100% 100%;
                margin: 0 auto;
