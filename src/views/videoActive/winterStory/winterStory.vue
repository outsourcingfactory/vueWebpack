<template>
    <div id="app">
        <div class="itemcontent" v-show="!showWx">
            <div>
                <div class="topimage">
                    <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/winterStory-image_01.png`"></Onepic>
                ...
                <div class="topimage">
                    <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/winterStory-image_02.png`"></Onepic>
                </div>
                <div class="bottomBtn" @click="goCreateVideo()">
                    <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/winterStory-bottom-btn.png`"></Onepic>
                </div>
...
<script>
    ...
    let shareTitle = '冬日物语—短视频征集';
    let shareDesc = '用视频留住你的冬天';
    let shareImageUrl = 'https://img.hongrenshuo.com.cn/h5/winterStory-share.jpg';
    export default {
        data() {
            return {
                leftActive: true,
                rightActive: false,
                exampleVideo: ['1216456569537953949','1206919220995031050','1221436691491848239'],
...
//                        等待封装toast
            ...
            goRule: function () {
                window.location.href = '/Rule/winterStoryrule';
            },
            ...
            goCreateVideo: function () {
                if (na.match(/hongdoulive/i)) {
                    _hmt.push(['_trackEvent', '马上去参赛', '端内点击']);
                    ...
                    _hmt.push(['_trackEvent', '马上去参赛', '端外点击']);
...
<style lang="scss" scoped>
    #app {
        ...
        .content {
            border-top: 1px solid #8dadca;
            border-bottom: 1px solid #8dadca;
            background: #eaf0fe;
            width: 100%;
            .title {
                width: 100%;
