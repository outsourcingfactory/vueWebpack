<template>
    <div id="app">
        <div class="itemcontent" v-show="!showWx">
            <div>
                <div class="topimage">
                    <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/modao-image_01.png`"></Onepic>
                ...
                <div class="content">
                    ...
                    <div class="tipsAl">
                        本活动最终解释权归《魔道祖师》动画和KilaKila所有
                    </div>
                </div>
                <div class="bottomBtn" @click="goCreateVideo()">
                    <Onepic :imgSrc="`https://img.hongrenshuo.com.cn/h5/modao-bottom-btn.png`"></Onepic>
                </div>
...
<script>
    ...
    let shareTitle = '15秒安利魔道祖师动画！';
    let shareDesc = 'CV签名周边+动画周边+现金大奖，用短视频向全世界安利魔道祖师动画吧！';
    let shareImageUrl = 'https://img.hongrenshuo.com.cn/h5/modao-shareicon.png';
    export default {
        data() {
            return {
                leftActive: true,
                rightActive: false,
                exampleVideo: ['1153264556798115898','1154451462420430905','1153275891216810080','1153275457425113162','1153271458810560564'],
...
//                        等待封装toast
            ...
            goRule: function () {
                window.location.href = '/Rule/modao-rule.html';
            },
...
<style lang="scss" scoped>
    #app {
        ...
        .content {
            border-top: 1px solid #386e8f;
            border-bottom: 1px solid #386e8f;
            background: #c2d0e0;
            width: 100%;
            .title {
                width: 100%;
